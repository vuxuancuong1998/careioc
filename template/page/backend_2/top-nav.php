<div class="iq-navbar-custom">
	  <nav class="navbar navbar-expand-lg navbar-light p-0">
		  ...
		  <div class="d-flex align-items-center">
			  ...
			  <a href="<?php echo XC_URL;?>" target="_blank" class="btn btn-success btn-sm">
				<svg xmlns="http://www.w3.org/2000/svg" class="text-white" width="24" fill="none" viewBox="0 0 24 24" stroke="currentColor">
			  ...
			  <div class="collapse navbar-collapse" id="navbarSupportedContent">
				  <ul class="navbar-nav ml-auto navbar-list align-items-center">
											   ...
											   <div class="list-item d-flex justify-content-start align-items-start">
												   <div class="avatar">
													  <div class="avatar-img avatar-success avatar-20">
														  <span><img class="avatar is-squared rounded-circle" src="<?php echo $template_path; ?>/backend/assets/images/user/2.jpg" alt="2.jpg"></span>
													  </div>
												  </div>
												  <div class="list-style-detail ml-2 mr-2">
					  ...
					  <li class="nav-item nav-icon dropdown">
						  ...
						  <img src="<?php echo $template_path; ?>/backend/assets/images/Flag/flag-vn.png" class="img-fluid rounded-circle" alt="user" style="height: 30px; min-width: 30px; width: 30px;">
						  <span class="bg-primary"></span>
						  </a>
							  ...
							  <div class="card shadow-none m-0 border-0">
								  <div class=" p-0 ">
									  <ul class="dropdown-menu-1 list-group list-group-flush">
										  <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0" href="#"><img src="<?php echo $template_path; ?>/backend/assets/images/Flag/flag-en.png" alt="img-flaf" class="img-fluid mr-2" style="width: 15px;height: 15px;min-width: 15px;"/>English</a></li>
									  </ul>
								  </div>
							  </div>
						  </div>
					  ...
					  <li class="nav-item nav-icon dropdown">
						  <a href="#" class="nav-item nav-icon dropdown-toggle pr-0 search-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
							  <img src="<?php echo ($user->user_avatar)? XC_URL."/uploads/users/".$user->user_avatar : $template_path."/backend/assets/images/user/5.jpg";?>" class="img-fluid avatar-rounded" alt="user">
							  <span class="mb-0 ml-2 user-name"><?php echo $user->user_firstname." ".$user->user_lastname;?></span>
						  </a>
						  <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
							  ...
							  <li class="dropdown-item  d-flex svg-icon border-top">
								  ...
								  <a href="<?php echo XC_URL;?>/admin/logout">Đăng xuất</a>
							  </li>
						  </ul>
					  </li>
				  </ul>                     
