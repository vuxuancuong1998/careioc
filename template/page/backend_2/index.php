         ...
         <div class="d-flex flex-wrap justify-content-between align-items-center">
             ...
             <div class="form-group mb-0 vanila-daterangepicker d-flex flex-row">
                  <div class="date-icon-set">
                     <input type="text" name="start" class="form-control" placeholder="Từ ngày">
                     ...
                     <span class="btn">Đến</span>
                  </span>
                  <div class="date-icon-set">
                     <input type="text" name="end" class="form-control" placeholder="Đến ngày">
                     <span class="search-link">
                        <svg xmlns="http://www.w3.org/2000/svg" class="" width="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
         ...
         <div class="row">
               ...
               <div class="card">
                  <div class="card-body">
                     <div class="d-flex align-items-center">
                        <div class="">
                            <p class="mb-2 text-secondary">Doanh thu</p>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="">
                            <p class="mb-2 text-secondary">Đơn hàng</p>
                            <div class="d-flex flex-wrap justify-content-start align-items-center">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="">
                           <p class="mb-2 text-secondary">Khách hàng</p>
                           <div class="d-flex flex-wrap justify-content-start align-items-center">
            ...
            <div class="card">
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center flex-wrap">
                     <h4 class="font-weight-bold">Báo cáo bán hàng</h4>
            ...
            <div class="card-body-list">               
               <ul class="list-style-3 mb-0">
                  <li class="p-3 list-item d-flex justify-content-start align-items-center">
                     <div class="avatar">
                        <img class="avatar avatar-img avatar-60 rounded" src="<?php echo $template_path; ?>/manager/assets/images/products/1.jpg" alt="1.jpg">                        
                     </div>
                  ...
                  <li class="p-3 list-item d-flex justify-content-start align-items-center">
                     <div class="avatar">
                        <img class="avatar avatar-img avatar-60 rounded" src="<?php echo $template_path; ?>/manager/assets/images/products/2.jpg" alt="2.jpg">                        
                     </div>
                     <div class="list-style-detail ml-3 mr-2">
                  ...
                  <li class="p-3 list-item d-flex justify-content-start align-items-center">
                     <div class="avatar">
                        <img class="avatar avatar-img avatar-60 rounded" src="<?php echo $template_path; ?>/manager/assets/images/products/13.jpg" alt="3.jpg">                        
                     </div>
                     <div class="list-style-detail ml-3 mr-2">
                  ...
                  <li class="p-3 list-item d-flex justify-content-start align-items-center">
                     <div class="avatar">
                        <img class="avatar avatar-img avatar-60 rounded" src="<?php echo $template_path; ?>/manager/assets/images/products/4.jpg" alt="4.jpg">                        
                     </div>
                     <div class="list-style-detail ml-3 mr-2">
                     ...
                     <tbody>
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="avatar-45 mr-2">
                                    <img src="<?php echo $template_path; ?>/manager/assets/images/user/2.jpg" class="img-fluid rounded-circle"
                                       alt="image">
                                 </div>
                        ...
                        <tr class="white-space-no-wrap">
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="avatar-45 mr-2">
                                    <img src="<?php echo $template_path; ?>/manager/assets/images/user/5.jpg" class="img-fluid rounded-circle"
                                       alt="image">
                                 </div>
                        ...
                        <tr class="white-space-no-wrap">
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="avatar-45 mr-2">
                                    <img src="<?php echo $template_path; ?>/manager/assets/images/user/1.jpg" class="img-fluid rounded-circle"
                                       alt="image">
                                 </div>
                                 <div>Max Lynn</div>
                              </div>
                        ...
                        <tr class="white-space-no-wrap">
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="avatar-45 mr-2">
                                    <img src="<?php echo $template_path; ?>/manager/assets/images/user/3.jpg" class="img-fluid rounded-circle"
                                       alt="image">
                                 </div>
                                 <div>Danniw Yatt</div>
                              </div>
