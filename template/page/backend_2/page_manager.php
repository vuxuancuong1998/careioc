...
<script>
	...
	$(document).ready(function(){
			...
			Swal.fire({
			  ...
			  if (result.isConfirmed) {
				  var id = button.attr("data-id");
					$.ajax({
						type: "POST",
						url: "<?php echo XC_URL;?>/api/deletepage",
						data: {id:id},
						dataType: "json",
						cache: false,
		...
		$(".btn-edit-place").on("click", function()
		{
			...
			$.ajax({
				type: "POST",
				url: "<?php echo XC_URL;?>/api/getpage",
				data: {id:id},
				dataType: "json",
				cache: false,
				success: function(data)
		...
		$("#btn-save-place").on("click",function()
		{
			...
			$.ajax({
				type: "POST",
				url: "<?php echo XC_URL;?>/api/addpage",
				data: fd,
				dataType: "json",
				cache: false,
...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Danh sách trang tĩnh</h1>
            <button type="button" class="btn btn-alt-success my-2" id="btn-add-place">
                <i class="fa fa-fw fa-plus mr-1"></i> Thêm trang
            </button>
        </div>
   </div>
</div>
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
				...
				<?php
					...
					<tr>
                        ...
                        <td class="font-w600"><?php echo $post->page_title;?></td>
                        <td class="d-none d-sm-table-cell">
							<?php echo $post->user_fullname;?>
                        </td>
						<td><?php echo date("d/m/Y",strtotime($post->page_date));?></td>
						<td class="text-center">
                            <div class="btn-group">
								<a class="btn btn-sm btn-primary" target="_blank" href="<?php echo $this->url->permalink($post->pid,"page");?>">
        ...
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-primary-dark">
                    <h3 class="block-title">Thêm trang</h3>
                ...
                <div class="block-content">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="dm-post-add-title">Tiêu đề trang</label>
