...
<script>
	...
	$(document).ready(function(){
		...
		$(".btn-edit-places").on("click", function()
		{
		...
		$("#btn-save-places").on("click",function()
		{
			var id = $("#placeid").val();
    ...
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            ...
            <button type="button" class="btn btn-alt-success my-2" id="btn-add-place">
                <i class="fa fa-fw fa-plus mr-1"></i> Thêm tỉnh
            </button>
        </div>
   </div>
</div>
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
				...
				<?php
					...
					<tr>
                        ...
                        <td class="font-w600"><?php echo $p->province_name;?></td>
						<td><?php echo number_format($p->countpost,0);?></td>
						<td class="text-center">
                            <div class="btn-group">
                                <button type="button" data-id="<?php echo $p->id;?>" class="btn btn-sm btn-primary js-tooltip-enabled btn-edit-place" data-toggle="tooltip" title="" data-original-title="Edit">
                ...
                <div class="block-content">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="dm-post-add-title">Tên tỉnh</label>
                        ...
                        <div class="form-group row">
                            <div class="col-xl-12">
                                ...
                                <label class="custom-file-label" for="example-file-input-custom">Chọn ảnh</label>
                            </div>
                            </div>
                        </div>
                    </div>
