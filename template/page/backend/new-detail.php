         ...
         <div class="card">
            ...
            <div class="card-body">
                <div class='row'>
                    ...
                    <div class = 'col-8'><?php echo $new_detail -> new_name;?></div><p>
                    <div class = 'col-2'>Mô tả ngắn:</div>
                    <div class = 'col-10'><?php echo $new_detail -> new_description;?></div><p></p>
                    <div class = 'col-2'>Nội dung:</div>
                    <div class = 'col-10'><?php echo $new_detail -> new_content;?></div>
