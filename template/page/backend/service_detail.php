       ...
       $('#summernote_new').summernote({
           ...
           toolbar: [
			...
			// if ($("#frm-action").valid()) {
				...
				formData.append('service_content', content);
				formData.append('service_user_created', $('#uid').val());
         ...
         <div class="card">
            ...
            <div class="card-body">
                <div class='row'>
                    ...
                    <div class = 'col-8'><?php echo $service_detail -> service_name;?></div><p>
                    <div class = 'col-2'>Mô tả ngắn:</div>
                    <div class = 'col-10'><?php echo $service_detail -> service_description;?></div><p></p>
                    <div class = 'col-2'>Nội dung:</div>
                    <div class = 'col-10'><?php echo $service_detail -> service_content;?></div>
