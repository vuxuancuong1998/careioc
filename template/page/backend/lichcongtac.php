               ...
               <div class="table-responsive">
                  <table id="table-calendar_works" class="table table-center table-hover datatable">
                     ...
                     <tbody>
                        <?php 
							$i = 1;
							foreach($calendar_work as $calendar_work)
                           {
                           ?>
                        <tr>
                           <td>
						    ...
						    <td >
                              <?php echo $calendar_work->calendar_work_name;?>
                           </td>
                           <td >
                              <?php echo $calendar_work->calendar_work_from_date;?>
                           </td>
                           <td >
                              <?php echo $calendar_work->calendar_work_to_date;?>
                           </td>
						   
                           		
                           <td><?php echo $calendar_work->calendar_work_created_date;?></td>	
