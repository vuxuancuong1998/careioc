...
<script>
	...
	$("#form-employee").validate({
		...
		if($("#form-customer").valid())
		{
			...
			$.ajax({ 
				type: "POST",
				url: "<?php echo XC_URL?>/api/addCustomer",
				data:{
					'id': customer_id,
...
<div class="content container-fluid">
   <div class="page-header">
      <div class="row">
         <div class="col-sm-12">
            <h3 class="page-title">Thêm sản phẩm</h3>
            <ul class="breadcrumb">
               <li class="breadcrumb-item"><a href="<?php echo XC_URL;?>">Cloud ERP</a></li>
               <li class="breadcrumb-item"><a href="<?php echo XC_URL;?>/app/customers">Sản phẩm</a></li>
               ...
               <form action="#" data-select2-id="13" id="form-customer">
                  <div class="row">
                     <div class="col-md-6" data-select2-id="12">
                        <div class="row">
							<div class="col-md-6">
                              <div class="form-group">
                                 <label>Mã sản phẩm:</label>
                                 <input type="text" readonly="true" value="<?php echo $product_code;?>" class="form-control" name='product_code' id='product_code'>
                              </div>
                           </div>
                           
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label>Mã vạch:</label>
                        ...
                        <div class="form-group">
                           <label>Mô tả:</label>
                           <textarea rows="3" cols="5" class="form-control" placeholder="Mô tả về sản phẩm" id='product_description'></textarea>
                        </div>
                     </div>
                     <div class="col-md-6">
                        ...
                        <div class="row">
						 <div class="col-md-12">
						   ...
						   <div class="col-md-6">
						    ...
						    <div class="col-md-4">
                              <div class="form-group">
                                 <label>Thuế VAT (%):</label>
                                 <input type="text" class="form-control" id='product_vat' name="product_vat">
                              </div>
                           </div>
						   <div class="col-md-4">
                              <div class="form-group">
                                 <label>Tên thuế VAT (%):</label>
                                 <input type="text" class="form-control" id='product_vat' name="product_vat">
                              </div>
                           </div>
                           <div class="col-md-4">
                  ...
                  <div class="text-end">
                     <button type="button" class="btn btn-primary" id = 'addProduct'>Thêm</button>
                  </div>
               </form>
            </div>
         </div>
