                  ...
                  <div class="row">
                              ...
                              <div class="form-group" >
								...
								<div class="col-md-6">
									...
									<div class="col-md-2">
										...
										<img src="<?php echo XC_URL . '/uploads/doctors/' . $employee->employee_image; ?>" width="80" height="80"/></td>
										<?php }else{?>
										<img src="<?php echo XC_URL . '/uploads/doctors/doctor_default.png'; ?>" width="80" height="80"/></td>
										<?php }?>
					 ...
					 <div class="form-group">
                           <label>Giới thiệu:</label>
							<textarea class='form-control' rows="5" cols="50" name = 'employee_des' id='employee_des' ><?php echo $employee->employee_des;?></textarea>
