...
<div class="content container-fluid">
   <div class="page-header">
      <div class="row">
         <div class="col-sm-12">
            <h3 class="page-title">Thêm Khách hàng/NCC</h3>
            <ul class="breadcrumb">
               ...
               <form action="#" data-select2-id="13" id="form-customer">
                  <div class="row">
                     <div class="col-md-6" data-select2-id="12">
                        <div class="row">
							<div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" readonly="true" value="<?php echo $customer_code;?>" class="form-control" name='customer_code' id='customer_code'>
                              </div>
                           </div>
                           ...
                           <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" id='customer_tax_code' name="customer_tax_code">
                              </div>
                           </div>
						   <div class="col-md-4">
                              <div class="form-group">
                                 <label>Loại:</label>
                                 <select class="select select2 form-control" id='customer_type' name="customer_type">
                        ...
                        <div class="form-group">
                           <label>Ghi chú:</label>
                           <textarea rows="3" cols="5" class="form-control" placeholder="Nội dung ghi chú về Khách hàng/NCC này" id='customer_note'></textarea>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="row">
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
								 ...
								 <option>Chọn nhóm</option>
									...
									?>
										<option value="<?php echo $customer_group->id;?>"><?php echo $customer_group->group_name;?></option>
									<?php 
									}
									?>
