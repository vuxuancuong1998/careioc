                        ...
                        <div class="card-body">
                           <div class="dash-widget-header">
                              ...
                              <div class="dash-count">
                                 <div class="dash-title">Dòng tiền</div>
                           ...
                           <p class="text-muted mt-3 mb-0"><span class="text-danger me-1"><i class="fas fa-arrow-down me-1"></i>1.15%</span> so với tuần trước</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xl-3 col-sm-6 col-12">
                     <div class="card">
                        <div class="card-body">
                           <div class="dash-widget-header">
                              ...
                              <div class="dash-count">
                                 <div class="dash-title">Khách hàng/NCC</div>
                                 <div class="dash-counts">
                                    <p>5</p>
                                 </div>
                              </div>
                           ...
                           <p class="text-muted mt-3 mb-0"><span class="text-success me-1"><i class="fas fa-arrow-up me-1"></i>2.37%</span> so với tuần trước</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xl-3 col-sm-6 col-12">
                     <div class="card">
                        <div class="card-body">
                           ...
                           <p class="text-muted mt-3 mb-0"><span class="text-success me-1"><i class="fas fa-arrow-up me-1"></i>3.77%</span> so với tuần trước</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xl-3 col-sm-6 col-12">
                     <div class="card">
                        <div class="card-body">
                           <div class="dash-widget-header">
                              ...
                              <div class="dash-count">
                                 <div class="dash-title">Doanh thu</div>
                                 <div class="dash-counts">
                                    <p>21.150.000đ</p>
                                 </div>
                              </div>
                           ...
                           <p class="text-muted mt-3 mb-0"><span class="text-danger me-1"><i class="fas fa-arrow-down me-1"></i>8.68%</span> so với tuần trước</p>
                        </div>
                     </div>
                  </div>
               </div>
